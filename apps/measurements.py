...
def measurements(amount, selection):
    ...
    if "square" in selection:  # change to be more dynamic
        ...
        # scenario 1 looks at the measurement selection and if it is larger i.e inches to feet it will divide by 12
        scenario1 = f"{measurement1} to {measurement2}"
        # scenario 2 does the opposite, will multiply by 2
        scenario2 = f"{measurement2} to {measurement1}"
    ...
    if scenario1 in lengths.keys():
        ...
        if Temperature.get(scenario1) == "A":
            print(
                f"{amount} degrees Celsius is equal to {round(32 + (float(amount) * 1.8),2)} degrees Fahrenheit")
            speak(
                f"{amount} degrees Celsius is equal to {round(32 + (float(amount) * 1.8),2)} degrees Fahrenheit")
        elif Temperature.get(scenario1) == "B":
            print(
                f"{amount} degrees Celsius is equal to {round(273.15 + (float(amount)),2)} degrees Kelvin")
            speak(
                f"{amount} degrees Celsius is equal to {round(273.15 + (float(amount)),2)} degrees Kelvin")
        elif Temperature.get(scenario1) == "C":
            print(
                f"{amount} degrees Celsius is equal to {round((491.67 + (float(amount) * 1.8)),2)} degrees Rankine")
            speak(
                f"{amount} degrees Celsius is equal to {round((491.67 + (float(amount) * 1.8)),2)} degrees Rankine")
        elif Temperature.get(scenario1) == "D":
            print(
                f"{amount} degrees Fahrenheit is equal to {round(((float(amount)-32)* (5/9))+273.15,2)} degrees Kelvin")
            speak(
                f"{amount} degrees Fahrenheit is equal to {round(((float(amount)-32)* (5/9))+273.15,2)} degrees Kelvin")
        elif Temperature.get(scenario1) == "E":
            print(
                f"{amount} degrees Fahrenheit is equal to {round(float(amount)+459.67,2)}")
            speak(
                f"{amount} degrees Fahrenheit is equal to {round(float(amount)+459.67,2)}")
        elif Temperature.get(scenario1) == "F":
            print(
                f"{amount} degrees Kelvin is equal to {round(float(amount)  * 9/5,2)}")
            speak(
                f"{amount} degrees Kelvin is equal to {round(float(amount)  * 9/5,2)}")
    elif scenario2 in Temperature.keys():
        if Temperature.get(scenario2) == "A":
            print(
                f"{amount} degrees Fahrenheit is equal to {round((float(amount)-32)* (5/9),2)} degrees Celsius")
            speak(
                f"{amount} degrees Fahrenheit is equal to {round((float(amount)-32)* (5/9),2)} degrees Celsius")
        elif Temperature.get(scenario2) == "B":
            print(
                f"{amount} degrees Kelvin is equal to {round(float(amount)-273.15,2)} degrees Celsius")
            speak(
                f"{amount} degrees Kelvin is equal to {round(float(amount)-273.15,2)} degrees Celsius")
        elif Temperature.get(scenario2) == "C":
            print(
                f"{amount} degrees Rankine is equal to {round((float(amount) - 491.67) * (5/9),2)} degrees Celsius")
            speak(
                f"{amount} degrees Rankine is equal to {round((float(amount) - 491.67) * (5/9),2)} degrees Celsius")
        elif Temperature.get(scenario2) == "D":
            print(
                f"{amount} degrees Kelvin is equal to {round(((float(amount)-273.15) * 1.8)+32,2)} degrees Fahrenheit")
            speak(
                f"{amount} degrees Kelvin is equal to {round(((float(amount)-273.15) * 1.8)+32,2)} degrees Fahrenheit")
        elif Temperature.get(scenario2) == "E":
            print(
                f"{amount} degrees Rankine is equal to {round(float(amount) - 459.67,2)} degrees Fahrenheit")
            speak(
                f"{amount} degrees Rankine is equal to {round(float(amount) - 459.67,2)} degrees Fahrenheit")
        elif Temperature.get(scenario2) == "F":
            print(
                f"{amount} degrees Rankine is equal to {round(float(amount) * (5/9),2)} degrees Kelvin")
            speak(
                f"{amount} degrees Rankine is equal to {round(float(amount) * (5/9),2)} degrees Kelvin")
