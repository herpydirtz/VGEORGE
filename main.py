...
def main():
    while (True):
        ...
        # TODO: give the ability to use short phrase like "mins" and allow for the time to be inserted before the word timer ie "create a 5 minute timer"
        if "timer" in user_input or "countdown" in user_input:
            ...
            amount = input(
                "please enter the numerical quantity you would like to convert: ")
